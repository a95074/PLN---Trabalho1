...
texto = re.sub(r'<text top="\d+" left="\d+" width="\d+" height="\d+" font="\d+"><i> n f</i></text>', '', texto) #remove os n 
texto = re.sub(r'<text top="\d+" left="\d+" width="\d+" height="\d+" font="\d+"><i> n</i></text>', '', texto)
